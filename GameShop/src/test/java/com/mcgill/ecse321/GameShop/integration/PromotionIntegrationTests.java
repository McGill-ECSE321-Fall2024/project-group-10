...
public class PromotionIntegrationTests {
    ...
    public void testCreateValidPromotion() {
        ...
        assertEquals(Date.valueOf("2023-10-01"), promotion.getStartDate());
        assertEquals(Date.valueOf("2023-10-31"), promotion.getEndDate());
    ...
    public void testUpdatePromotion() {
        ...
        updateRequest.setStartDate(Date.valueOf("2023-10-05"));
        updateRequest.setEndDate(Date.valueOf("2023-11-05"));
        ...
        assertEquals(Date.valueOf("2023-10-05"), updatedPromotion.getStartDate());
        assertEquals(Date.valueOf("2023-11-05"), updatedPromotion.getEndDate());
    }
    ...
    public void testCreatePromotionInvalidData() {
        ...
        promotionRequest.setStartDate(Date.valueOf("2023-10-01"));
        promotionRequest.setEndDate(Date.valueOf("2023-10-31"));
    ...
    public void testUpdatePromotionInvalidId() {
        ...
        updateRequest.setStartDate(Date.valueOf("2023-10-01"));
        updateRequest.setEndDate(Date.valueOf("2023-10-31"));
    ...
    public void testCreatePromotionStartDateAfterEndDate() {
        ...
        PromotionRequestDto promotionRequest = new PromotionRequestDto(
            ...
            20,
            Date.valueOf("2023-11-01"),
            Date.valueOf("2023-10-01"), // End date before start date
            managerEmail,
            gameIds
        );
