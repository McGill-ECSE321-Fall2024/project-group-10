...
public class PlatformServiceTests {
    ...
    public void testGetPlatformByValidId() {
        // Arrange
        Manager manager = new Manager(VALID_MANAGER_EMAIL+"s", "managerUser", "managerPass", "123-456-7890", "123 Manager Street");


        // Mock the manager repository to return the manager
        // when(managerRepository.findByEmail(VALID_MANAGER_EMAIL)).thenReturn(manager);

        when(platformRepository.findById(VALID_PLATFORM_ID)).thenReturn(new Platform(VALID_PLATFORM_NAME, manager));


        // // Act
        Platform foundPlatform = platformService.getPlatform(VALID_PLATFORM_ID);

        // Assert
        assertNotNull(foundPlatform);
        // assertEquals(VALID_PLATFORM_ID, foundPlatform.getPlatform_id(), "Platform ID does not match");
    ...
    // Arrange
    Manager manager = new Manager(VALID_MANAGER_EMAIL+"oiu", "managerUser", "managerPass", "123-456-7890", "123 Manager Street");
    ...
    public void testUpdatePlatform() {
        ...
        Manager manager = new Manager(VALID_MANAGER_EMAIL+"ss", "managerUser", "managerPass", "123-456-7890", "123 Manager Street");
        ...
        when(platformRepository.save(any(Platform.class))).thenAnswer((InvocationOnMock invocation) -> invocation.getArgument(0));
    ...
    public void testUpdatePlatformWithNullPlatformName() {
        // Arrange
        Manager manager = new Manager(VALID_MANAGER_EMAIL+"sdss", "managerUser", "managerPass", "123-456-7890", "123 Manager Street");
        Platform platform = new Platform(VALID_PLATFORM_NAME, manager);
    ...
    public void testDeletePlatform() {
        // Arrange
        Manager manager = new Manager(VALID_MANAGER_EMAIL+"sdssa", "managerUser", "managerPass", "123-456-7890", "123 Manager Street");
