...
public class SpecificGameController {
    ...
    // @GetMapping("/specificGames/{specificGame_id}")
    // public SpecificGameResponseDto findSpecificGameById(@PathVariable int
    // specificGame_id) {
    // SpecificGame specificGame =
    // specificGameService.findSpecificGameById(specificGame_id);
    // return SpecificGameResponseDto.create(specificGame);
    // }
    ...
    // @PostMapping("/specificGames")
    // public SpecificGameResponseDto createSpecificGame(@Valid @RequestBody
    // SpecificGameRequestDto request) {
    // SpecificGame createdSpecificGame =
    // specificGameService.createSpecificGame(GameService.findGameById(request.getGame_id()));
    // return SpecificGameResponseDto.create(createdSpecificGame);
    // }
    ...
    // Return Specific Game for return request taking as args (customer_id,
    // specificGame_id)
}
