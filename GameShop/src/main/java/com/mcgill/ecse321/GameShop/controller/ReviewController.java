...
public class ReviewController {
     ...
     * Create a new review.
     * 
     * @param request the review request data transfer object containing the details of the review to be created
     * @return the response data transfer object containing the details of the created review
     */
    @PostMapping("/reviews")
     ...
     * @return the response data transfer object containing the details of the retrieved review
     */
     ...
     * @return the account response data transfer object containing the details of the customer who wrote the review
     */
     ...
     * @return a list data transfer object containing the summaries of all reviews for the specified game
     */
     ...
     * @return a list data transfer object containing the summaries of all reviews done by the specified customer
     */
     ...
     * @return the reply response data transfer object containing the details of the reply to the specified review
     */
     ...
     * @return the response data transfer object containing the details of the updated review
     */
