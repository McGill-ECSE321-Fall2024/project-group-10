...
public class GameController {
     ...
     * Create a new game.
     * 
     * @param request the game request data transfer object containing the details of the game to be created
     * @return the response data transfer object containing the details of the created game
     */
    @PostMapping("/games")
     ...
     * @param request the game request data transfer object containing the updated details of the game
     * @return the response data transfer object containing the details of the updated game
     */
    @PutMapping("/games/{id}")
     ...
     * @return a list data transfer object containing the summaries of the games with the specified title
     */
     ...
     * @return a list data transfer object containing the summaries of the games with the specified status
     */
     ...
     * @return a list data transfer object containing the summaries of the games with the specified stock quantity
     */
